...
from my_scraper.items import LivingSocialDeal
...
class LivingSocialSpider(BaseSpider):
    ...
    item_fields = {'title': './/a/div[@class="deal-bottom"]/h3[@itemprop]/text()',
                   ...
                   'price': './/a/div[@class="deal-bottom"]/ul[@class="unstyledn deal-info"]/li[@class="deal-price"]/text()'}
